...
namespace MyTaskApp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925221920_AgentActivity")]
    partial class AgentActivity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyTaskApp.Domain.Agents.AgentSession", b =>
                {
                    ...
                    b.Property<long?>("ActivityChangedAt")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("HookTokenHash")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex(new[] { "TaskDevelopmentId" }, "IX_AgentSessions_TaskDevelopmentId_Active")
                        .IsUnique()
            ...
            modelBuilder.Entity("MyTaskApp.Infrastructure.Persistence.AgentSettingsRow", b =>
                {
                    ...
                    b.Property<bool?>("MonitorActivity")
                        .HasColumnType("INTEGER");
